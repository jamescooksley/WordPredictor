...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(
    ...
    menuItem("Source code", icon = icon("file-code-o"), 
             href = "https://github.com/jamescooksley/WordPredictor")
  )
)
...
body <- dashboardBody(
  ...
  tabItems(
    ...
    tabItem(tabName = "about",
            ...
            p("The source code of this app is available at", tags$a("GitHub", href="https://github.com/jamescooksley/WordPredictor"), ".")
    )
  )
